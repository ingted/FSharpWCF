...
using AsianOptionsFSharp.AsianOptionsServiceFSharp;
    ...
    public partial class Sheet1
    {
        ...
        private void Run_Click(object sender, EventArgs e)
        {
            ...
            using (Session session = Session.CreateSession(info))
            {
                ...
                using (AsianOptionsServiceFSharpClient client = new AsianOptionsServiceFSharpClient(binding, session.EndpointReference))
                {
