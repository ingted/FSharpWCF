...
using AsianOptions4.FRAsianOptionsService4;
...
namespace AsianOptions4
{
    public partial class Sheet2
    {
        ...
        private void submitReq()
        {
            ...
            SessionStartInfo info = new SessionStartInfo((string)rngHeadnode.Value2, (string)this.Range["B13", missing].Value2);
            ...
            using (DurableSession session = DurableSession.CreateSession(info))
            {
                ...
                using (BrokerClient<AsianOptions4.FRAsianOptionsService4.IAsianOptions4> client = 
                    new BrokerClient<AsianOptions4.FRAsianOptionsService4.IAsianOptions4>(session, binding))
                {
                    int count = 0;
